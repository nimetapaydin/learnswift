...
class DetailsViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var kaydetButtonTiklandi: UIButton!
    ...
    override func viewDidLoad() {
        ...
        if secilenUrunIsmi != "" {
            ...
            kaydetButtonTiklandi.isHidden = true
            
            
            //core data secilen ürün bilgilerini goster
            ...
            if let uuidString = secilenUrunUUID?.uuidString {
                ...
                kaydetButtonTiklandi.isHidden = false
                kaydetButtonTiklandi.isEnabled = false
                isimTextField.text = ""
                fiyatTextField.text = ""
                bedenTextField.text = ""
            }
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        kaydetButtonTiklandi.isEnabled = true
